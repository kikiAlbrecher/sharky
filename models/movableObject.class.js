...
class MovableObject extends DrawableObject {
    ...
    */
    ...
    /**
     * Determines if the character is swimming to the right.
     * The protagonist can swim right if the RIGHT key is pressed and he hasn't reached the level's end.
     * 
     * @returns {boolean} True if Sharky is swimming to the right, otherwise false.
     */
    sharkySwimsRight() {
    ...
    /**
     * Determines if the character is swimming to the left.
     * The protagonist can swim left if the LEFT key is pressed and he hasn't crossed the left boundary.
     * 
     * @returns {boolean} True if Sharky is swimming to the left, otherwise false.
     */
    sharkySwimsLeft() {
    ...
    /**
     * Determines if the character is swimming upwards.
     * The protagonist can swim up if the UP key is pressed and he hasn't reached the upper boundary.
     * 
     * @returns {boolean} True if Sharky is swimming up, otherwise false.
     */
    sharkySwimsUp() {
    ...
    /**
     * Determines if the character is swimming downwards.
     * The protagonist can swim down if the DOWN key is pressed and he is above the ground.
     * 
     * @returns {boolean} True if Sharky is swimming down, otherwise false.
     */
    sharkySwimsDown() {
